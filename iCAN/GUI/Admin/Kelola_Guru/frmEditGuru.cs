...
namespace iCAN.GUI.Admin
{
    public partial class frmEditGuru : MetroFramework.Forms.MetroForm
    {
        ...
        private void frmEditGuru_Load(object sender, EventArgs e)
        {
            ...
            txUsername.Text = siswa.Username;
            txNIS.Text = siswa.myNIS;
            txNama.Text = siswa.Nama;
            int jk = siswa.Jenis_kelamin;
            if (jk == 1)
            {
            ...
            cbKelas.Text = siswa.Nama_kelas;
            txTempatL.Text = siswa.Tempat_lahir;
            txTanggalL.Value = Convert.ToDateTime(siswa.Tanggal_lahir);
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                siswa.Username = txUsername.Text;
                if (txPassword.Text != "")
                    siswa.Password = txPassword.Text;
                ...
                siswa.Nama = txNama.Text;
                siswa.Tempat_lahir = txTempatL.Text;
                siswa.Tanggal_lahir = txTanggalL.Value.ToString();
                siswa.Agama = cbAgama.Text;
                siswa.Alamat = txAlamat.Text;
                bool status = siswa.saveSiswatoDB();
                if (status)
                {
